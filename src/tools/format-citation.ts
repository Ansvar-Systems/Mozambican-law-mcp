/**
 * format_citation — Format a Mozambique legal citation per standard conventions.
 *
...
import { generateMeta, type ResponseMeta } from '../utils/metadata.js';
...
export async function formatCitationTool(
  ...
  return { original: input.citation, formatted, format, _meta: generateMeta(db) };
}
