...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Mozambican legal professional rules.
...
- Law Society of Mozambique rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/mozambique-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Mozambique)

### Law Society of Mozambique and Advocates Act

Mozambican lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Mozambique Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Mozambique Law Reports, LexisNexis East Africa)
...
2. Follow Mozambican government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/mozambique-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Mozambique ethics guidance
